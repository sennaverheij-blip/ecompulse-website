...
const faqs = [
  {
    ...
    answer:
      "EcomPulse is designed for both brands and dropshipping stores, offering tailored solutions for each. Whether you run a DTC brand with custom products or a dropshipping operation, our email flows are optimized for your specific business model.",
  },
  {
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div>
          ...
          <p className="mt-4 text-[#999] text-base">
        ...
        <div className="flex flex-col gap-3">
          {faqs.map((faq, i) => {
            ...
            return (
              <button
                key={i}
                className={`w-full text-left rounded-xl px-6 py-4 transition-all duration-300 cursor-pointer ${
                  isOpen ? "faq-item-open" : "faq-item-closed hover:border-[#3a3a3a]"
                }`}
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <svg
                    className={`shrink-0 transition-transform duration-300 text-[#999] ${
                      isOpen ? "rotate-45" : ""
                    }`}
                    width="18"
                    height="18"
