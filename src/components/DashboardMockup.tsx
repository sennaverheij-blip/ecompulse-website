  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-2xl p-5 sm:p-6 w-full max-w-md shadow-2xl shadow-black/40 relative">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-[10px] text-[#6b6b6b] font-display">EcomPulse</span>
      </div>

      {/* Revenue display */}
      <div className="mb-1">
        <p className="text-[10px] uppercase tracking-wider text-[#6b6b6b] mb-1">Total Revenue</p>
        <p className="text-2xl sm:text-3xl font-bold text-white font-display">A$1,334,591.40</p>
      </div>

      <div className="flex items-center gap-4 mb-6">
        <div>
          <p className="text-[10px] text-[#6b6b6b]">Attributed Revenue</p>
      ...
      <div className="grid grid-cols-4 gap-3 mb-6">
        {[
          ...
          <div key={m.label}>
            <p className="text-[9px] text-[#6b6b6b]">{m.label}</p>
