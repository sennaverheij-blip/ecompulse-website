    ...
    <footer className="border-t border-[#222] pt-16 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mt-6">
            <a href="#" className="text-[#888] hover:text-white transition-colors" aria-label="Twitter/X">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="#" className="text-[#888] hover:text-white transition-colors" aria-label="Instagram">
            ...
            <a href="#" className="text-[#888] hover:text-white transition-colors" aria-label="YouTube">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="mt-16 pt-8 border-t border-[#222] flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="#" className="text-xs text-[#555] hover:text-white transition-colors">Privacy Policy</a>
          <a href="#" className="text-xs text-[#555] hover:text-white transition-colors">Terms of service</a>
        </div>
      </div>
    </footer>
  );
